...
<% String name = session.getAttribute("id").toString();
    ...
    String sql = "select * from sec_user where user_id='" + id + "'";
    try {
            ...
            <div class="topbar-main"><a id="menu-toggle" href="#" class="hidden-xs"><i class="fa fa-bars"></i></a>
                ...
                <div class="news-update-box hidden-xs"><span class="text-uppercase mrm pull-left text-white">News:</span>
                    <ul id="news-update" class="ticker list-unstyled">
                        <li>Welcome to Buddy College Management System</li>
                ...
                <ul class="nav navbar navbar-top-links navbar-right mbn">
                    ...
                    <li id="topbar-chat" class="hidden-xs"><a href="javascript:void(0)" data-step="4" data-intro="&lt;b&gt;Form chat&lt;/b&gt; keep you connecting with other coworker" data-position="left" class="btn-chat"><i class="fa fa-comments"></i><span class="badge badge-info"></span></a></li>
                </ul>
            </div>
        </nav>
        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="dashboard.jsp"><i class="fa fa-tachometer fa-fw">
                        <div class="icon-bg bg-orange"></div>
                    </i><span class="menu-title">Dashboard</span></a></li>
                    <li><a href="timetable.jsp"><i class="fa fa-desktop fa-fw">
                    ...
                    <li><a href="Bus.jsp"><i class="fa fa-th-list fa-fw">
                        <div class="icon-bg bg-blue"></div>
                        ...
                        <div class="row">
                                ...
                                <div class="page-content">
                                    ...
                                    <tbody>
                                         <% while (rs.next()) {
                %>
                                       <tr><td class="user-name">User Name</td><td class="user-email"><%=rs.getString(2)%></td></tr>
                        <tr><td class="user-name">First Name</td><td class="user-email"><%=rs.getString(5)%></td></tr>
                        <tr><td class="user-name">Last Name</td><td class="user-email"><%=rs.getString(6)%></td></tr>
                        <tr><td class="user-name">Mobile</td><td class="user-email"><%=rs.getString(9)%></td></tr>
                        <tr><td class="user-name">Blood Group</td><td class="user-email"><%=rs.getString(7)%></td></tr>
                        <tr><td class="user-name">Address</td><td class="user-email"><%=rs.getString(8)%></td></tr>
                        <tr><td class="user-name">Department</td><td class="user-email"><%=rs.getString(10)%></td></tr>
                            ...
                            <div class="col-lg-8">
                                <div class="timeline-centered timeline-sm">
                                    ...
                                    <div class="timeline-entry-inner">
                                        ...
                                        <div class="timeline-label bg-orange"><h4 class="timeline-title"> Feeds</h4>
