        ...
        <div>
            ...
            <div id="wrapper">
                ...
                <nav id="sidebar" role="navigation" data-step="2" data-intro="Template has &lt;b&gt;many navigation styles&lt;/b&gt;"
                    ...
                    <li class="active"><a href="Bus.jsp"><i class="fa fa-th-list fa-fw">
                        <div class="icon-bg bg-blue"></div>
                                    ...
                                    <table class="table table-hover table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="route" value="sat 1" size="100"></td>
                                                        ...
                                                        <div id="grid-layout-table-1" class="box jplist">
                                                            ...
                                                            <div class="jplist-panel box panel-top">
                                                                ...
                                                                <div class="text-filter-box">
                                                                    <div class="input-group"><span class="input-group-addon"><i class="fa fa-search"></i></span><input data-path=".title" type="text" value="" placeholder="Filter by Busno" data-control-type="textbox" data-control-name="title-filter" data-control-action="filter" class="form-control"/></div>
                                                                </div>
                                                                <div class="text-filter-box">
                                                                    <div class="input-group"><span class="input-group-addon"><i class="fa fa-search"></i></span><input data-path=".desc" type="text" value="" placeholder="Filter by Route" data-control-type="textbox" data-control-name="desc-filter" data-control-action="filter" class="form-control"/></div>
                                                                </div>
                                                            ...
                                                            <div class="box text-shadow">
                                                                <table class="demo-tbl">
                                                                    ...
                                                                    <tr class="tbl-item"><!--<img/>-->
                                                                        <td class="img"><img src="images/thumbs/arch-1.jpg" alt="10" title=""></td>
                                                                        <!--<data></data>-->

                                                                        <td class="td-block"><p class="date"></p>

                                                                            <p class="title"><%=rs.getString(1)%></p>
