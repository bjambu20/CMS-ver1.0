                ...
                <ul id="side-menu" class="nav">
                   ...
                   <li><a href="dashboard.jsp"><i class="fa fa-tachometer fa-fw">
                    ...
                    <li><a href="timetable.jsp?id=<%=id%>"><i class="fa fa-desktop fa-fw">
                       ...
                       <li  class="active"><a href="attendance.jsp?id=<%=id%>"><i class="fa fa-edit fa-fw">
...
<%
 ...
 if(id !=null)
   ...
   String studentid = "select * from attendance where student_id='" + id + "' " ;
