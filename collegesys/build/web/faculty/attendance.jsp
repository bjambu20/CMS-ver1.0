            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li><a href="timetable.jsp"><i class="fa fa-desktop fa-fw">
                       ...
                       <li class="active"><a href="attendance.jsp"><i class="fa fa-edit fa-fw">
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-violet">
                            ...
                            <div class="panel-body">
                                <form name="f1">
                                    <h3>Choose</h3>
                                    <h3> Department   <select name="department" id="department">
...
<input type="hidden" name="classid" value="<%=cdid%>" />
                     <label>
                        ...
                        <input type="date" required autocomplete="off" id="date" name="date"/>
                            ...
                            %>
                                    <tr>
                                <th><%=rs.getString(1)%></th><td><%=rs.getString(2)%></td><td><select name="status<%=i%>">
