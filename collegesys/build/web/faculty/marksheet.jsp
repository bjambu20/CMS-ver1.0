    ...
    <body>
        ...
        <div>
            ...
            <div id="wrapper">
                ...
                <nav id="sidebar" role="navigation" data-step="2" data-intro="Template has &lt;b&gt;many navigation styles&lt;/b&gt;"
                    ...
                    <li><a href="timetable.jsp"><i class="fa fa-desktop fa-fw">
                     ...
                     <li class="active"><a href="marksheet.jsp"><i class="fa fa-edit fa-fw">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="panel panel-blue" style="background:#FFF;">
                                                <div class="panel-heading">Mark Entry</div>
                                                <div class="panel-body">
                                                    <form name="f1">
                                                        <table class="table table-striped table-hover">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td> Test Name</td><td><select name="test">
                                                        ...
                                                        <option>test5</option>
                                                            ...
                                                            <tr>
                                                                <td> Department </td><td>  <select name="department" id="department">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>  Year</td><td>  <select name="year" id="year" onChange="document.f1.submit()" >
                                                                <option>Select</option>
                                                                <option>1</option>
                                                                <option>2</option>
                                                                <option>3</option>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            ...
                                            <table class="table table-hover table-bordered">
                                                <thead>
                                                    <tr>
                                                        <th>ID</th><th>Name</th><th>Sub1</th><th>Sub2</th><th>Sub3</th><th>Sub4</th><th>Sub5</th><th>Sub6</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <%
                                                    ...
                                                    %>
                                                    <tr>
                                                        <th><%=rs.getString(1)%></th><td><%=rs.getString(2)%></td>
                                                        <td><input type="text" name="asub<%=i%>" value="sub1" /> </td>
                                                        <td><input type="text" name="bsub<%=i%>" value="sub2" /> </td>
                                                        <td><input type="text" name="csub<%=i%>" value="sub3" /> </td>
                                                        <td><input type="text" name="dsub<%=i%>" value="sub4" /> </td>
                                                        <td><input type="text" name="esub<%=i%>" value="sub5" /> </td>
                                                        <td><input type="text" name="fsub<%=i%>" value="sub6" /> </td>
                                                    </tr>
                                                <input type="hidden" name="studentid<%=i%>" value="<%=rs.getString(1)%>" />
                                                </tbody>
          ...
          i++;
                                            ...
                                            <input type="hidden" name="strength" value="<%=i%>" />
