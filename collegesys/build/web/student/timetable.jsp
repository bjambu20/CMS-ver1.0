...
<%                                                String id = request.getParameter("id");
 %>
                    ...
                    <li class="active"><a href="timetable.jsp?id=<%=id%>"><i class="fa fa-desktop fa-fw">
...
//                                                        d_id = Integer.parseInt(department);
                                                        String classid = "select * from sec_user where user_id='" + id + "'";
                                                        rs = st.executeQuery(classid);
                                                        if (rs.next()) {
                                                            cdid = rs.getString(10);
                                                        }
                                                        String studentid = "select * from time_table where classid='" + cdid + "'";
                                            ...
                                            <form action="addtime.jsp">  
                                                <div class="panel-body">
                                                    <!--<h4  align="center">  Department :<%=department%> Year :<%=year%>   </h4>-->
                                                    ...
                                                    <table class="table table-hover table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            %>
                                                            <% if (i == 0) {
                                                            %><h4 align="center">Will update soon</h4><% }%>
